...
public class RatingProcess : AggregateRoot
{
    ...
    public RatingProcess(string hotelId, string reservationId, string guestId, string status, HotelReview? review)
    {
    ...
    public RatingProcess(string hotelId, string reservationId, string guestId, string status)
    {
        HotelId = hotelId ?? throw new ArgumentNullException(nameof(hotelId));
        ReservationId = reservationId ?? throw new ArgumentNullException(nameof(reservationId));
        Status = status ?? throw new ArgumentNullException(nameof(status));
